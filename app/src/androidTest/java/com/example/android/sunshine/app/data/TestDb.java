...
import static com.example.android.sunshine.app.data.TestUtilities.validateCursor;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    public long testLocationTable() {
        ...
        Cursor checkResult = db.query(WeatherContract.LocationEntry.TABLE_NAME, null, "_ID=?", new String[] {String.valueOf(locationRowId)}, null, null, null, null);

        // Move the cursor to a valid database row
        assertTrue("no result", checkResult.moveToFirst());
        validateCurrentRecord("cursor empty", checkResult, locationValues);
        assertFalse("more than 1 result in location test", checkResult.moveToNext());
        checkResult.close();
        db.close();
        ...
        // query if you like)
        //validateCurrentRecord("record not found", checkResult, locationValues);
    ...
    public void testWeatherTable() {
        ...
        // Query the database and receive a Cursor back
        Cursor checkResultWeather = db.query(
        ...
        assertTrue("no result", checkResultWeather.moveToFirst());
        validateCurrentRecord("cursor empty", checkResultWeather, weatherValues);
        assertFalse("more than 1 result in weather test", checkResultWeather.moveToNext());
        checkResultWeather.close();
        db.close();
